<template>
  <div class="bg">
    <div class="whitebg">
      ...
      <div
        style="display: flex; justify-content: center; height: 450px; margin-left: 120px; margin-right: 120px; width: 400px;"
      >
        <!-- 登录界面 -->
        <a-form-model
          v-if="switchLogin"
          ...
          style="height: 600px;"
          >
          <h3 class="welcomelogo" style="margin-top: 100px; color: #13c2c2">账号密码登录</h3>
        ...
        <a-form-model
          ...
          style="height: 520px;"
        >
          <h3 class="welcomelogo" style="margin-top: 70px; margin-bottom: 24px; color: #13c2c2">账号注册</h3>         
